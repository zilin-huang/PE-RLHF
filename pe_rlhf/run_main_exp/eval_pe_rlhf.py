...
def get_function(exp_path, ckpt_idx):
    ...
    trainer = PE_RLHFTrainer(dict(env=HumanInTheLoopEnv))
...
if __name__ == '__main__':
    # hyperparameters
    CKPT_PATH ='/home/sky-lab/codes/PE-RLHF/pe_rlhf/run_main_exp/PE_RLHF/PE_RLHFTrainer_HumanInTheLoopEnv_656a2_00000_0_seed=0_2024-07-01_17-51-04'
